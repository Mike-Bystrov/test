...
/**
 * <p>Java class for tpneutraltiinformation complex type</p>.
 * 
...
public class Tpneutraltiinformation {
     ...
     * This is why there is not a <CODE>set</CODE> method for the tradeitemcountryoforiginCollection property.</p>
     * 
     * <p>
     ...
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the barcodetypeCollection property.</p>
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * </p>
     ...
     * 
     * @return
     *     The value of the barcodetypeCollection property.
     */
    public List<Barcodetype> getBarcodetypeCollection() {
        if (barcodetypeCollection == null) {
            barcodetypeCollection = new ArrayList<>();
        }
     ...
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the tradeitemcountryofassemblyCollection property.</p>
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * </p>
     ...
     * 
     * @return
     *     The value of the tradeitemcountryofassemblyCollection property.
     */
    public List<Tradeitemcountryofassembly> getTradeitemcountryofassemblyCollection() {
        if (tradeitemcountryofassemblyCollection == null) {
            tradeitemcountryofassemblyCollection = new ArrayList<>();
        }
     ...
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the classcomplianceregulationcodeCollection property.</p>
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * </p>
     ...
     * 
     * @return
     *     The value of the classcomplianceregulationcodeCollection property.
     */
    public List<Classcomplianceregulationcode> getClasscomplianceregulationcodeCollection() {
        if (classcomplianceregulationcodeCollection == null) {
            classcomplianceregulationcodeCollection = new ArrayList<>();
        }
