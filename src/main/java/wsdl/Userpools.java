...
/**
 * <p>Java class for userpools complex type</p>.
 * 
    ...
    extends TradeitemAddons
{
     ...
     * This is why there is not a <CODE>set</CODE> method for the userpoolscontentCollection property.</p>
     * 
     * <p>
     ...
     * 
     * @return
     *     The value of the userpoolscontentCollection property.
     */
    public List<Userpoolscontent> getUserpoolscontentCollection() {
        if (userpoolscontentCollection == null) {
            userpoolscontentCollection = new ArrayList<>();
        }
