...
/**
 * <p>Java class for nextlowerleveltiinformation complex type</p>.
 * 
...
public class Nextlowerleveltiinformation {
     ...
     * This is why there is not a <CODE>set</CODE> method for the childtradeitemCollection property.</p>
     * 
     * <p>
     ...
     * 
     * @return
     *     The value of the childtradeitemCollection property.
     */
    public List<Childtradeitem> getChildtradeitemCollection() {
        if (childtradeitemCollection == null) {
            childtradeitemCollection = new ArrayList<>();
        }
