...
/**
 * <p>Java class for tradeitemtscertificate complex type</p>.
 * 
...
public class Tradeitemtscertificate {
     ...
     * This is why there is not a <CODE>set</CODE> method for the tradeitemrbCollection property.</p>
     * 
     * <p>
     ...
     * 
     * @return
     *     The value of the tradeitemrbCollection property.
     */
    public List<Tradeitemrb> getTradeitemrbCollection() {
        if (tradeitemrbCollection == null) {
            tradeitemrbCollection = new ArrayList<>();
        }
