...
/**
 * <p>Java class for securityusers complex type</p>.
 * 
    ...
    extends SecurityusersAddons
{
     ...
     * This is why there is not a <CODE>set</CODE> method for the partyCollection property.</p>
     * 
     * <p>
     ...
     * 
     * @return
     *     The value of the partyCollection property.
     */
    public List<Party> getPartyCollection() {
        if (partyCollection == null) {
            partyCollection = new ArrayList<>();
        }
     ...
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the userpoolsCollection property.</p>
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * </p>
     ...
     * 
     * @return
     *     The value of the userpoolsCollection property.
     */
    public List<Userpools> getUserpoolsCollection() {
        if (userpoolsCollection == null) {
            userpoolsCollection = new ArrayList<>();
        }
     ...
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the securityauthoritiesCollection property.</p>
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * </p>
     ...
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the poolsCollection property.</p>
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * </p>
     ...
     * 
     * @return
     *     The value of the poolsCollection property.
     */
    public List<Pools> getPoolsCollection() {
        if (poolsCollection == null) {
            poolsCollection = new ArrayList<>();
        }
